...
const S = {
  ...
  pageHeadIcon: { width: '44px', height: '44px', borderRadius: '12px', background: '#F4F4F5', border: '1px solid #E4E4E7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '19px', color: '#3F3F46', flexShrink: 0 },
  ...
  candidateAvatar: { width: '50px', height: '50px', borderRadius: '50%', background: '#F4F4F5', border: '1px solid #E4E4E7', color: '#18181B', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '19px', fontWeight: '700', flexShrink: 0 },
