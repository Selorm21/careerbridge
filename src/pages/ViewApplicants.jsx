...
export default function ViewApplicants() {
  ...
  function getStatusStyle(status) {
    if (status === 'applied') return { bg: '#EFF6FF', color: '#2563EB' }
    if (status === 'interview') return { bg: '#FFFBEB', color: '#D97706' }
    if (status === 'offer') return { bg: '#ECFDF5', color: '#059669' }
  ...
  return (
    <div style={S.page}>
      <style>{`
        ...
        .appCard:hover{box-shadow:0 12px 28px rgba(37,99,235,0.09)!important;border-color:#DBEAFE!important}
...
const S = {
  ...
  jobBanner: { background: '#fff', borderRadius: '16px', padding: '24px 28px', border: '1px solid #F0F2F5', boxShadow: '0 2px 8px rgba(15,23,42,0.04)', marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' },
  jobBannerLeft: { display: 'flex', alignItems: 'center', gap: '16px' },
  jobIconWrap: { width: '52px', height: '52px', borderRadius: '14px', background: '#EFF6FF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '26px' },
  heading: { fontSize: '20px', fontWeight: '800', color: '#0F172A', marginBottom: '4px' },
  jobMeta: { fontSize: '13.5px', color: '#94A3B8', fontWeight: '500' },
  ...
  appBio: { fontSize: '13px', color: '#64748B', fontStyle: 'italic', marginBottom: '12px', lineHeight: '1.5' },
  ...
  appNum: { fontSize: '12px', color: '#CBD5E1', fontWeight: '700' },
